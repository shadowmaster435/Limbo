...
public class ModModelGenerator extends FabricModelProvider {
    ...
    public void generateItemModels(ItemModelGenerator itemModelGenerator) {
        ...
        if (args.contains("itemdgen") || args.contains("dgenall")) {
            generic_items(itemModelGenerator);
        }
    }

    public static void generic_items(ItemModelGenerator itemModelGenerator) {
        ModItems.generic_items.forEach((s, item) -> itemModelGenerator.register(item, Models.GENERATED));
    }
