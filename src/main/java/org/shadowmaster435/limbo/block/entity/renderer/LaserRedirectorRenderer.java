...
public class LaserRedirectorRenderer implements BlockEntityRenderer<LaserRedirectorEntity> {
    ...
    public LaserRedirectorRenderer(BlockEntityRendererFactory.Context ctx) {

    }
    @Override
    public void render(LaserRedirectorEntity entity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
        ...
        for (int i = 0; i < entity.distance; ++i) {
